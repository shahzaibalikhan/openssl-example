...
all: clean bin/aes-encdec bin/gen-ecdsa-key bin/initialize-fips bin/fips-selftest bin/fips-mode-status bin/triple-des bin/fips-zerorize
...
bin/triple-des:
	@echo "+ $@"
	@$(CC) triple-des/main.c -o $@ $(CFLAGS) $(LDFLAGS)
